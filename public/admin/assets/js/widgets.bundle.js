                        ...
                        series: [
                            {
                                name: "Sales",
                                data: [
                                    3.5, 5.7, 2.8, 5.9, 4.2, 5.6, 4.3, 4.5, 5.9,
                                    4.5, 5.7, 4.8, 5.7,
                                ],
                            },
                        ],
                        ...
                        series: [
                            {
                                name: "Shipments",
                                data: [
                                    1.5, 4.5, 2, 3, 2, 4, 2.5, 2, 2.5, 4, 3.5,
                                    4.5, 2.5,
                                ],
                            },
                        ],
                        ...
                        series: [
                            {
                                name: "Sales",
                                data: [
                                    4.5, 5.7, 2.8, 5.9, 4.2, 5.6, 5.2, 4.5, 5.9,
                                    4.5, 5.7, 4.8, 5.7,
                                ],
                            },
                        ],
                        ...
                        series: [
                            {
                                name: "Visitors",
                                data: [
                                    1.5, 2.5, 2, 3, 2, 4, 2.5, 2, 2.5, 4, 2.5,
                                    4.5, 2.5,
                                ],
                            },
                        ],
                        ...
                        series: [
                            {
                                name: "Subscribed",
                                data: [
                                    20, 30, 20, 40, 60, 75, 65, 18, 10, 5, 15,
                                    40, 60, 18, 35, 55, 20,
                                ],
                            },
                            {
                                name: "Unsubscribed",
                                data: [
                                    -20, -15, -5, -20, -30, -15, -10, -8, -5,
                                    -5, -10, -25, -15, -5, -10, -5, -15,
                                ],
                            },
                        ],
                        chart: {
                                ...
                                n.columns.template.adapters.add(
                                    ...
                                    function (e, t) {
                                        return a
                                            .get("colors")
                                            .getIndex(
                                                n.dataItems.indexOf(t.dataItem)
                                            );
                                    }
                                );
                            var d = a.series.push(
                ...
                if ("undefined" != typeof am5) {
                    var e,
                        t = document.getElementById(
                            "kt_charts_widget_19_chart_2"
                        );
                    if (t) {
                        var a = function () {
                            (e = am5.Root.new(t)).setThemes([
                                am5themes_Animated.new(e),
                            ]);
                            ...
                            var o = a.xAxes.push(
                                ...
                                i = am5radar.AxisRendererRadial.new(e, {
                                    minGridDistance: 20,
                                });
                            i.labels.template.setAll({
                                centerX: am5.p100,
            ...
            if (t) {
                var a = t.getAttribute("data-kt-chart-color"),
                    ...
                    n = {
                        series: [
                            {
                                name: "Overview",
                                data: [
                                    15, 15, 45, 45, 25, 25, 55, 55, 20, 20, 37,
                                ],
                            },
                        ],
                        chart: {
                        ...
                        colors: [s],
                        markers: { colors: s, strozkeColor: i, strokeWidth: 3 },
                    };
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    s = {
                        series: [
                            {
                                ...
                                data: [
                                    34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35,
                                    35.5, 35.5, 35, 35, 34.5, 34.5, 35, 35,
                                    35.4, 35.4, 35,
                                ],
                            },
                        ],
                        ...
                        yaxis: {
                            max: 36.3, //Data Ventas
                            min: 33,
                            tickAmount: 6,
                            labels: {
                                style: { colors: l, fontSize: "12px" },
                                formatter: function (e) {
                                    return "S/." + parseInt(10 * e);
                                },
                            },
                        },
                        states: {
                        ...
                        a = function () {
                            ...
                            function r(e) {
                                ...
                                for (l = 0; l < e.length; l++) {
                                    var r;
                                    ((r = e[l]).malePercent =
                                        (-1 * Math.round((r.male / t) * 1e4)) /
                                        100),
                                        (r.femalePercent =
                                            Math.round((r.female / a) * 1e4) /
                                            100);
                                }
                                return e;
                            }
                            ...
                            p.mapPolygons.template.setAll({
                                ...
                                p.mapPolygons.template.events.on(
                                    "click",
                                    function (e) {
                                        f && f.set("active", !1),
                                        ...
                                        for (
                                            var t =
                                                    e.target.dataItem.dataContext.id
                                                        .split("-")
                                                        .pop(),
                                                a = r(l[t]),
                                                o = 0;
                                            ...
                                            m.data.setIndex(o, a[o]),
                                                c.data.setIndex(o, a[o]);
                                        u.set(
                                            "text",
                                            e.target.dataItem.dataContext.name
                                        );
                                    }
                                );
                        };
                        ...
                        a = function () {
                            ...
                            l.labels.template.setAll({
                                ...
                                l.grid.template.setAll({
                                    location: 0.5,
                                    strokeDasharray: [2, 2],
                                    stroke: KTUtil.getCssVariableValue(
                                        "--bs-gray-400"
                                    ),
                                });
                            var r = a.xAxes.push(
                            ...
                            var i = a.yAxes.push(
                                am5xy.ValueAxis.new(t, { renderer: o })
                            );
                        ...
                        series: [
                            {
                                name: "Links",
                                data: [
                                    190, 230, 230, 200, 200, 190, 190, 200, 200,
                                    220, 220, 200, 200, 210, 210,
                                ],
                            },
                        ],
                        chart: {
                        ...
                        series: [
                            {
                                name: "Sales",
                                data: [
                                    18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18,
                                    18, 20, 20, 18, 18, 20, 20, 22,
                                ],
                            },
                        ],
                        chart: {
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t,
                        a,
                        l = function () {
                            (a = am5.Root.new(e)).setThemes([
                                am5themes_Animated.new(a),
                            ]),
                            ...
                            var r = t.xAxes.push(
                                ...
                                o = am5radar.AxisRendererRadial.new(a, {
                                    minGridDistance: 30,
                                });
                            o.labels.template.setAll({
                                fontWeight: "500",
                            ...
                            var i = t.yAxes.push(
                                am5xy.ValueAxis.new(a, { renderer: o })
                            );
                            o.grid.template.setAll({
                                strokeDasharray: [2, 2],
                                stroke: KTUtil.getCssVariableValue(
...
var KTChartsWidget33 = (function () {
    ...
    return {
        init: function () {
            ...
            var n = [
                    2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900,
            ...
            var m = [
                    2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3200, 3200,
            ...
            var g = [
                    1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3300,
                    2400, 2400, 3e3, 3200, 3100,
                ],
                f = [
                    "Jun 2021",
                    "Jul 2021",
            ...
            var u = [
                    3e3, 2100, 3300, 3100, 1800, 1800, 2400, 2400, 3100, 3100,
                    2400, 2400, 3e3, 2400, 2800,
                ],
                p = [
                    "Sep 2021",
                    "Oct 2021",
...
var KTChartsWidget34 = (function () {
    ...
    return {
        init: function () {
            ...
            var n = [
                    2300, 2300, 2e3, 3100, 3100, 2800, 2400, 2400, 3100, 2900,
            ...
            var m = [
                    2600, 3400, 2300, 2300, 2e3, 3100, 3100, 2900, 3200, 3200,
                    2600, 3100, 2800, 2400, 2400,
                ],
                c = [
                    "Apr 02",
            ...
            var g = [
                    1800, 1800, 2400, 2400, 3100, 3100, 3e3, 2100, 3200, 3200,
                    2400, 2400, 3e3, 3200, 3100,
                ],
                f = [
                    "Jun 2021",
            ...
            var u = [
                    3e3, 2100, 3200, 3200, 1800, 1800, 2400, 2400, 3100, 3100,
                    2400, 2400, 3e3, 2400, 2800,
                ],
                p = [
                    "Sep 2021",
...
var KTChartsWidget35 = (function () {
    ...
    return {
        init: function () {
            ...
            var m = [
                    2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3400, 3400,
            ...
            var g = [
                    1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3200,
                    2400, 2400, 3e3, 3200, 3100,
                ],
                f = [
                    "Jun 2021",
            ...
            var u = [
                    3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250, 2400,
                    2400, 3250, 3e3, 2400, 2800,
                ],
                p = [
                    "Sep 2021",
                    "Oct 2021",
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    n = {
                        series: [
                            {
                                name: "Clientes Entrantes",
                                data: [
                                    65, 80, 80, 60, 60, 45, 45, 80, 80, 70, 70,
                                    90, 90, 80, 80, 80, 60, 60, 50,
                                ],
                            },
                            {
                                name: "Clientes Salientes",
                                data: [
                                    90, 110, 110, 95, 95, 85, 85, 95, 95, 115,
                                    115, 100, 100, 115, 115, 95, 95, 85, 85,
                                ],
                            },
                        ],
                        chart: {
                        ...
                        a = function () {
                            if ((t = am5.Root.new(e))) {
                                ...
                                var a = t.container.children.push(
                                    ...
                                    l = am5radar.AxisRendererCircular.new(
                                        t,
                                        {}
                                    );
                        ...
                        series: [
                            {
                                name: "Inbound Calls",
                                data: [
                                    45, 80, 53, 80, 75, 100, 76, 117, 76, 110,
                                    70, 112,
                                ],
                            },
                        ],
...
var KTSlidersWidget1 = (function () {
    var e = { self: null, rendered: !1 },
        ...
        l = function (e, t, a) {
            ...
            if (
                l &&
                (!0 !== e.rendered || !l.classList.contains("initialized"))
            ) {
...
var KTSlidersWidget3 = (function () {
    var e = { self: null, rendered: !1 },
        ...
        a = function (e, t, a, l) {
            ...
            if (
                r &&
                (!0 !== e.rendered || !r.classList.contains("initialized"))
            ) {
                var o = parseInt(KTUtil.css(r, "height")),
        ...
        t = () => {
            ...
            e &&
                e.forEach((e) => {
                    e.setAttribute(
                        "src",
                        e.getAttribute("data-kt-timeline-avatar-src")
                    ),
