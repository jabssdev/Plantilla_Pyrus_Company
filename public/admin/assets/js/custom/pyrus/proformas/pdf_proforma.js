"use strict";
var KTModalPDFProforma = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_pdf_proforma")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_pdf_proforma_form")),
                (t = document.getElementById("kt_modal_pdf_proforma_submit")),
                (e = document.getElementById("kt_modal_pdf_proforma_cancel")),
