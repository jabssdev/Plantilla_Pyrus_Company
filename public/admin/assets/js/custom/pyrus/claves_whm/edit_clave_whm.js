"use strict";
var KTModalEditClaveWHM = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_clave_whm")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_clave_whm_form")),
                (t = document.getElementById("kt_modal_edit_clave_whm_submit")),
                (e = document.getElementById("kt_modal_edit_clave_whm_cancel")),
