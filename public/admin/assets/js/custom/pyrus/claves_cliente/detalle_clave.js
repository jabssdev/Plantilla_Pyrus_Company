"use strict";
var KTModalDetalleClave = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_detalle_clave")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_detalle_clave_form")),
                (t = document.getElementById("kt_modal_detalle_clave_submit")),
                (e = document.getElementById("kt_modal_detalle_clave_cancel")),
