"use strict";
var KTModalEditClaveCliente = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_clave_cliente")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector(
                    "#kt_modal_edit_clave_cliente_form"
                )),
                (t = document.getElementById(
                    "kt_modal_edit_clave_cliente_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_edit_clave_cliente_cancel"
                )),
