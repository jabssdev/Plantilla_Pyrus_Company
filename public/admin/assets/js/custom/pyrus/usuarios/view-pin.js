"use strict";
var KTModalViewPIN = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_view_pin")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_view_pin_form")),
                (t = document.getElementById("kt_modal_view_pin_submit")),
                (e = document.getElementById("kt_modal_view_pin_cancel")),
