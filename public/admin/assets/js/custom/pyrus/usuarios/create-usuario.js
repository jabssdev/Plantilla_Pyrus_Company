"use strict";
var KTModalCreateUsuario = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_create_usuario")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_create_usuario_form")),
                (t = document.getElementById("kt_modal_create_usuario_submit")),
                (e = document.getElementById("kt_modal_create_usuario_cancel")),
