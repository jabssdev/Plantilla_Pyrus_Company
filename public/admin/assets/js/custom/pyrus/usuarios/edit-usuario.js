"use strict";
var KTModalEditUsuario = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_usuario")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_usuario_form")),
                (t = document.getElementById("kt_modal_edit_usuario_submit")),
                (e = document.getElementById("kt_modal_edit_usuario_cancel")),
