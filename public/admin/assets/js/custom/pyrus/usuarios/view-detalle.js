"use strict";
var KTModalViewDETALLE = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_view_detalle")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_view_detalle_form")),
                (t = document.getElementById("kt_modal_view_detalle_submit")),
                (e = document.getElementById("kt_modal_view_detalle_cancel")),
