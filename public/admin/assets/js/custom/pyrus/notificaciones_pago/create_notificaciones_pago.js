"use strict";
var KTTercerosNotificaciones = {
    init: function () {
        !(function () {
            var t;
            $("#kt_datepicker_1").flatpickr();
            var e = document.getElementById(
                    "kt_create_notificaciones_pago_form"
                ),
                i = e.querySelector("#kt_create_notificaciones_pago_submit");
            (t = FormValidation.formValidation(e, {
                fields: {
                    ...
                    numero: {
                        validators: {
                            notEmpty: { message: "El N° es obligatorio" },
                        },
                    },
                    fecha: {
                        validators: {
                ...
                i.addEventListener("click", function (e) {
                    e.preventDefault(),
                        t.validate().then(function (t) {
                            "Valid" == t
                                ? swal.fire({
                                      text: "La notificación de pago a sido creada con éxito",
                                      icon: "success",
                                      buttonsStyling: !1,
