"use strict";
var KTModalPDFNotificacion = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_pdf_notificacion")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_pdf_notificacion_form")),
                (t = document.getElementById(
                    "kt_modal_pdf_notificacion_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_pdf_notificacion_cancel"
                )),
