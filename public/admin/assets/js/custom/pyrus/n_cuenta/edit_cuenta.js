"use strict";
var KTModalEditCuenta = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_cuenta")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_cuenta_form")),
                (t = document.getElementById("kt_modal_edit_cuenta_submit")),
                (e = document.getElementById("kt_modal_edit_cuenta_cancel")),
