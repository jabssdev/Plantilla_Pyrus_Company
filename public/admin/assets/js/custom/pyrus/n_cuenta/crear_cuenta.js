"use strict";
var KTModalCreateCuenta = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_create_cuenta")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_create_cuenta_form")),
                (t = document.getElementById("kt_modal_create_cuenta_submit")),
                (e = document.getElementById("kt_modal_create_cuenta_cancel")),
                ...
                (n = FormValidation.formValidation(o, {
                    fields: {
                        cuenta: {
                            validators: {
                                notEmpty: {
                                    message: "La cuenta es obligatorio",
                                },
                            },
                        },
                    },
