"use strict";
var KTModalEditCategoria = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_categoria")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_categoria_form")),
                (t = document.getElementById("kt_modal_edit_categoria_submit")),
                (e = document.getElementById("kt_modal_edit_categoria_cancel")),
                ...
                $(o.querySelector('[name="fecha"]')).flatpickr({
                    enableTime: 0,
                    dateFormat: "d-m-Y",
                }),
                    ...
                    fields: {
                        categoria: {
                            validators: {
                                notEmpty: {
                                    message:
                                        "Seleccionar la categoría es obligatoria",
                                },
                            },
                        },
                    },
