"use strict";
var KTModalEditSubcategoria = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_subcategoria")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector(
                    "#kt_modal_edit_subcategoria_form"
                )),
                (t = document.getElementById(
                    "kt_modal_edit_subcategoria_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_edit_subcategoria_cancel"
                )),
                    ...
                    fields: {
                        subcategoria: {
                            validators: {
                                notEmpty: {
                                    message:
                                        "Seleccionar la subcategoría es obligatoria",
                                },
                            },
                        },
                    },
