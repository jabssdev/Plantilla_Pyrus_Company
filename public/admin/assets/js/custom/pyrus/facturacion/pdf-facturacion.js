"use strict";
var KTModalPDFFacturacion = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_pdf_facturacion")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_pdf_facturacion_form")),
                (t = document.getElementById(
                    "kt_modal_pdf_facturacion_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_pdf_facturacion_cancel"
                )),
