"use strict";
var KTModalEditPDFFacturacion = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_pdf_facturacion")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector(
                    "#kt_modal_edit_pdf_facturacion_form"
                )),
                (t = document.getElementById(
                    "kt_modal_edit_pdf_facturacion_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_edit_pdf_facturacion_cancel"
                )),
...
KTUtil.onDOMContentLoaded(function () {
    KTModalEditPDFFacturacion.init();
});
