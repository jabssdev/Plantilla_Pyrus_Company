"use strict";
var KTModalDetalleVenta = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_detalle_venta")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_detalle_venta_form")),
                (t = document.getElementById("kt_modal_detalle_venta_submit")),
                (e = document.getElementById("kt_modal_detalle_venta_cancel")),
