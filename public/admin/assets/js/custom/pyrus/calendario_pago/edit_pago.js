"use strict";
var KTModalEditPago = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_pago")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_pago_form")),
                (t = document.getElementById("kt_modal_edit_pago_submit")),
                (e = document.getElementById("kt_modal_edit_pago_cancel")),
