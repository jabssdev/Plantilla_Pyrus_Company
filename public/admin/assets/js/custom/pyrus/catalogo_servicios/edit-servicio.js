"use strict";
var KTModalEditServicio = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_servicio")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_servicio_form")),
                (t = document.getElementById("kt_modal_edit_servicio_submit")),
                (e = document.getElementById("kt_modal_edit_servicio_cancel")),
