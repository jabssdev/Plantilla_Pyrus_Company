"use strict";
var KTModalCreateServicio = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_create_servicio")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_create_servicio_form")),
                (t = document.getElementById(
                    "kt_modal_create_servicio_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_create_servicio_cancel"
                )),
