"use strict";
var KTModalPlanes = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_planes")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_planes_form")),
                (t = document.getElementById("kt_modal_planes_submit")),
                (e = document.getElementById("kt_modal_planes_cancel")),
