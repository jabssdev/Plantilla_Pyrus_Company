"use strict";
var KTModalEditCliente = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_edit_cliente")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_edit_cliente_form")),
                (t = document.getElementById("kt_modal_edit_cliente_submit")),
                (e = document.getElementById("kt_modal_edit_cliente_cancel")),
