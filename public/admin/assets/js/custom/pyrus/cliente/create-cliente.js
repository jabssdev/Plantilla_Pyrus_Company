"use strict";
var KTModalCreateCliente = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_create_cliente")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_create_cliente_form")),
                (t = document.getElementById("kt_modal_create_cliente_submit")),
                (e = document.getElementById("kt_modal_create_cliente_cancel")),
                    ...
                    fields: {
                        n_documento: {
                            validators: {
                                notEmpty: {
                                    message:
                                        "El n° de documento es obligatorio",
                                },
                            },
                        },
                        nombre: {
