"use strict";
var KTModalServicioCliente = (function () {
    var t, e, n, o, i, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_servicio_cliente")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_servicio_cliente_form")),
                (t = document.getElementById(
                    "kt_modal_servicio_cliente_submit"
                )),
                (e = document.getElementById(
                    "kt_modal_servicio_cliente_cancel"
                )),
