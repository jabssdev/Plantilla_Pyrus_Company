        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_claves_client_ocultos_table">
            <thead>
                <tr class="text-start text-gray-400 fw-semibold fs-7 gs-0 table-bg" style="border-bottom: none !important">
                    ...
                    <th class="min-w-60px text-center" style="padding-right: 10px !important;">Código Cliente</th>
                    <th class="min-w-100px text-center" style="padding-right: 10px !important;">Cpanel</th>
                    <th class="min-w-100px text-center" style="padding-right: 10px !important;">Usuario</th>
                    <th class="min-w-70px text-center" style="padding-right: 10px !important;">Clave</th>
                    <th class="min-w-70px text-center" style="padding-right: 10px !important;">Fecha Activación</th>
                    <th class="min-w-70px text-center" style="padding-right: 10px !important;">Fecha Término</th>
