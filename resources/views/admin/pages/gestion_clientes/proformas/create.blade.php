...
<div class="card">
  ...
  <div class="card-header">
    <!--begin::Card title-->
    <div class="card-title fs-3 fw-bold"><i class="ki-outline ki-note fs-1 text-pyrus"></i></span>&nbsp; Proformas</div>
    <!--end::Card title-->
  </div>
  <!--end::Card header-->

  <!--begin::Form-->
  <form id="kt_create_proforma_form" class="form">
    <!--begin::Card body-->
    <div class="card-body p-9">
      ...
      <div class="row mb-5">
        <!--begin::Col-->
        <div class="col-lg-4">
          <label class="fs-6 fw-semibold mt-2 mb-3 text-black">Servicio:</label>

          <!--begin::Input group-->
          <div id="editor_servicio" style="border:1px solid var(--bs-gray-300);color:var(--bs-input-color)">
          </div>
          <!--end::Input group-->
        </div>
        <!--end::Col-->
        ...
        <!--begin::Col-->
        <div class="col-lg-4">
          <label class="fs-6 fw-semibold mt-2 mb-3 text-black">Hosting y Dominio:</label>

          <!--begin::Input group-->
          <div id="editor_hosting_dominio" style="border:1px solid var(--bs-gray-300);color:var(--bs-input-color)">
            <p><strong>Hosting Empresarial</strong></p>
            <ul>
              <li>Espacio: 5 GB</li>
              <li>Velocidad: 300 GB</li>
              <li>Base de Datos: ilimitada</li>
              <li>Cuentas de Correo: 100</li>
            </ul>
            <p><strong>DOMINIO: en .COM</strong></p>
            <p><strong>CERTIFICADO SSL: INCLUIDO</strong></p>
          </div>
          <!--end::Input group-->
        </div>
        <!--end::Col-->
        ...
        <!--begin::Col-->
        <div class="col-lg-4">
          <label class="fs-6 fw-semibold mt-2 mb-3 text-black">Inv. Anual:</label>

          <!--begin::Input group-->
          <div id="editor_inv_anual" style="border:1px solid var(--bs-gray-300);color:var(--bs-input-color)">
          </div>
          <!--end::Input group-->
        </div>
        <!--end::Col-->
        ...
        <!--begin::Col-->
        <div class="col-lg-4">
          <label class="fs-6 fw-semibold mt-2 mb-3 text-black">Inv. Total:</label>

          <!--begin::Input group-->
          <input type="number" class="form-control" style="margin-top: 30px;" placeholder="Escribe la inversión total aquí...">
          <!--end::Input group-->
        </div>
        <!--end::Col-->

        <!--begin::Col-->
        <div class="col-lg-4 d-flex align-items-center justify-content-center" style="margin-top: 45px;">
        ...
        <table class="table align-middle gs-0 gy-4">
          ...
          <thead>
            <tr class="fw-semibold text-muted table-bg">
              ...
              <th class="min-w-90px text-center">Servicio</th>
              <th class="min-w-90px text-center">Descripción</th>
              <th class="min-w-120px text-center">Hosting y Dominio</th>
              <th class="min-w-120px text-center">Inv. Anual</th>
              <th class="min-w-120px text-center">Inv. Total</th>
      ...
      <div class="row mb-5 justify-content-end">
        ...
        <div class="col-lg-4 order-2">
          <!--begin::Input group-->
          <div id="editor_footer_table" style="border:1px solid var(--bs-gray-300);color:var(--bs-input-color)">
          </div>
          <!--end::Input group-->
        </div>
        <!--end::Col-->
    ...
    <div class="card-footer d-flex justify-content-center py-6 px-9">
      <a href="{{route('proforma.index')}}" class="btn btn-danger me-2"> Cancelar </a>
      <button type="submit" class="btn btn-primary" id="kt_create_proforma_submit">Generar</button>
    </div>
    <!--end::Card footer-->
  </form>
  <!--end:Form-->
